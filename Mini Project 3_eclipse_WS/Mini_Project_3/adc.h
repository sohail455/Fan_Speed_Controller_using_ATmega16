...
typedef enum
{
	DIVISION_2,DIVISION_4=2,DIVISION_8,DIVISION_16,DIVISION_32,DIVISION_64,DIVISION_128
}ADC_Prescaler;/*enum to choose the prescaler to supply clock to the ADC*/

typedef struct{
 ADC_ReferenceVolatge ref_volt;
 ADC_Prescaler prescaler;
}ADC_ConfigType;/*configuration structure to chosse the reference voltage and prescalre*/
/*******************************************************************************
